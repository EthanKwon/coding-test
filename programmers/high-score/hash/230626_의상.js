...
var getCombinationByClothes = function (clothes) {
    ...
    return Array.from(clothesClassMap.values()).reduce(function (calc, num) { return calc * (num + 1); }, 1) - 1;
};
exports.getCombinationByClothes = getCombinationByClothes;
//Test
var test = (0, exports.getCombinationByClothes)([["yellow_hat", "headgear"], ["blue_sunglasses", "eyewear"], ["green_turban", "headgear"]]);
console.log("결과 : ", test);
